...
const CACHE = 'synera-shell-20260905-real-v2';
const SHELL = ['/', '/index.html', '/style.css', '/app.mjs', '/online-store.mjs', '/profile-portability.mjs', '/profile-brief.mjs', '/profile-package.mjs', '/calendar.mjs', '/matching.mjs', '/map.mjs', '/pilot-policy.mjs', '/pwa.mjs', '/manifest.webmanifest', '/icon-192.png', '/icon-512.png', '/apple-touch-icon.png', '/legal.html'];
