...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFE7BD87);
  late Color secondary = const Color(0xFFDFA579);
  late Color tertiary = const Color(0xFF2DD2B7);
  late Color alternate = const Color(0xFFD3D3D3);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFF3F4F7);
  late Color primaryBackground = const Color(0xFF15161D);
  late Color secondaryBackground = const Color(0xFF2B3138);
  ...
  late Color success = const Color(0xFF9CD323);
  late Color warning = const Color(0xFFFFC73A);
  late Color error = const Color(0xFFFF4423);
  late Color info = const Color(0xFF54A6FF);
}
