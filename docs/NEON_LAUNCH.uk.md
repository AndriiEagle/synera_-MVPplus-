...
Оновлення r7, 2026-09-06: виправлено неправильну назву cookie в адаптері, додано відновлення входу, HSTS, оновлено мобільний дизайн і додано вибіркове перенесення професійної чернетки з особистого ChatGPT. 75/75 тестів. Власник успішно ввів новий код; прихований профіль збережений і відновлений після перезавантаження. Див. [звіт про виправлення](LOGIN_FIX_2026-09-05.uk.md) та [інструкцію перенесення](CHATGPT_PROFILE_TRANSFER.uk.md).
...
- Опублікований ZIP r7: `../synera-neon-pilot-20260906-r7.zip`, 24 файли. SHA256 `9FC141F3308D410B2D6DE3A9A5763C6705E53B2701D295DEAABC0A69B78B71B3`. Попередні ZIP збережено.
